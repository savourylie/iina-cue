...
- Pinned Gemma 4 E2B and Qwen3 ForcedAligner model cards declare Apache 2.0. Read `THIRD_PARTY_NOTICES.md` before downloading models. This project cannot accept license terms on the user's behalf, and the notices are not legal advice.
