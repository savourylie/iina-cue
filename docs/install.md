...
During development, restart IINA after rebuilding; repeated Reload All Plugins produced duplicate sidebar tabs in IINA 1.4.4 during testing. Normal installed use does not require reloading plugins.
