...
## Minimum memory (TICKET-011)

2026-09-25: no 8 GB Apple Silicon Mac was available, so the 8 GB and 16 GB playback measurements were not run. Cue requires 16 GB, and the sidebar refuses less before any download. This is a default for lack of evidence, not a measured limit. Known numbers: 3.33 GB peak footprint including Metal on the 36 GB M3 Max above (18 s synthetic clip), and 2.11 GB peak RSS with runtime 0.1.6 on a 64 GB M1 Ultra (54 s English clip, zh-TW translation; RSS excludes some Metal memory). Whether an 8 GB Mac stays responsive during a 20-minute playback is still unknown.
